    ...
    <div id="main-content">
           ...
           <img src="../img/image.png" class="main-content-image">
            <div class="banner-overlay">
                ...
                <div class="breadcrumbs">
                        <a href="../home.php">HOME</a> • <a href="academics.php">ACADEMIC PROGRAMS</a> • EDUCATION
                </div>
            </div>
        </div>
    </div>
        <div class="container">
            ...
            <div class="section-heading">
                <h1>College of Education Programs</h1>
                <p>Prepare to shape the future. Our programs focus on pedagogical excellence, child development, and curriculum design across all learning levels.</p>
            </div>

            <div class="program-grid">
                <div class="program-card">
                    <div class="card-header">
                        <h3 style="font-size: 23.2px;">BS Early Childhood Education</h3>
                    </div>
                    <div class="card-content">
                        <p>Specializes in the development and learning of children from birth through age eight. Focuses on play-based learning, cognitive development, and creating nurturing environments.</p>
                ...
                <div class="program-card">
                    ...
                    <div class="card-content">
                        <p>Trains future educators for teaching in primary and intermediate grades (K-6). Covers multi-disciplinary teaching strategies, classroom management, and child psychology.</p>
                        <a href="#" class="btn-details">View Curriculum</a>
                    </div>
                </div>
                ...
                <div class="program-card">
                    ...
                    <div class="card-content">
                        <p>Prepares subject-matter experts to teach in high school. Specialization areas include Science, Math, English, and Social Studies, focusing on adolescent learning and curriculum delivery.</p>
                        <a href="#" class="btn-details">View Curriculum</a>
                    </div>
                </div>
            </div>
