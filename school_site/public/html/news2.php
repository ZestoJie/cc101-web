...
<header class="site-header">
    ...
    <div class="article-header">
            ...
            <img src = "../img/international.jpg"class="article-photo">

        <h1 class="article-title">
           MSU GOES INTERNATIONAL
        </h1>
    ...
    <div class="article-content">
        <p>
            Scholars, success, and everything nice, Meridian State University has it all in the Philippines. 
            Now, they finally take the next step forward, greeting the world.
        </p>

        <p>
            MSU finally goes international after striking a partnership deal with the University of Tokyo in Japan, one of the most
            prestigious University in their country.
        </p>

        <p>
            The deal included student exchange programs, which can lead to MSU students becoming known in the world, as well as UTokyo 
            students experiencing the illustrious teachings of MSU.
        </p>

        <p>
            This marks a huge step for MSU, getting even closer towards the University’s vision and marking it as one of the most well renowned
            universities in the Philippines.
        </p>
    </div>
    <div class="article-navigation">
        <div></div>
        <a href="news1.php" class="next-article">&lt; Back</a>
    </div>
    <div class="article-navigation">
        <div></div>
        <a href="news3.php" class="next-article">Next Article &gt;</a>
    </div>
