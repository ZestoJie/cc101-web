           ...
           <img src="../img/image.png" class="main-content-image">
            <div class="banner-overlay">
                    ...
                    <div class="breadcrumbs">
                        <a href="../home.php">HOME</a> • <a href="campuslife.php">CAMPUS LIFE</a> • SPORTS
                    </div>
                </div>
            </div>
                </div>
...
<div class="choice">
    <a href="sports1.php" class="news-card">
        <img src="../img/uaap.png" alt="News Image">
        <h3>Rising Maroons<br>topples<br>Blue Hawks</h3>
    </a>

    <a href="sports2.php" class="news-card">
        <img src="../img/jb.jpg" alt="News Image">
        <h3>Meridian<br>Captures the<br>Elysium</h3>
    </a>

    <a href="sports3.php" class="news-card">
        <img src="../img/win.jpg" alt="News Image">
        <h3>MSU clenches<br>the goal,<br>FEU falls</h3>
    </a>
</div>
