...
<header class="site-header">
    ...
    <div class="article-header">
            ...
            <img src = "../img/jb.jpg"class="article-photo">

        <h1 class="article-title">
           MERIDIAN CAPTURES THE ELYSIUM
        </h1>
    ...
    <div class="article-content">
         Meridian State University (MSU) takes control of the board after defeating Elysium International School (EIS) in the Inter-college Sports Association 
       (ICSA) chess competition, 5-4.
        <br>
        <br>
        The match consisted of a best-of-9 match between the two schools, with MSU’s Lyro Garcia and EIS’ Jett Jameson. 
        <br>
        <br>
       Garcia dominated the start of the game with a 4-0 lead, winning 4 games straight, however, Jameson retaliated with 4 wins of his own, leading to the 
       nerve wrecking game 9 between the 2 players.
        <br>
        <br>
       Garcia clenched the victory through an endgame win, the scenarios in which the young Meridian excels the most.
        <br>
        <br>
        This marks the first ever win that MSU had against EIS when it comes to chess, also putting them in the quarterfinals of the tournament.
    </div>

    <div class="article-navigation">
        <div></div>
        <a href="sports1.php" class="next-article">&lt; Back</a>
    </div>
    <div class="article-navigation">
        <div></div>
        <a href="sports3.php" class="next-article">Next Article &gt;</a>
    </div>
