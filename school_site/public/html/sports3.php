...
<header class="site-header">
    ...
    <div class="article-header">
            ...
            <img src = "../img/win.jpg"class="article-photo">
    ...
    <div class="article-content">
        ...
        The Meridian Scholars University (MSU) Football team manages to squeeze a nail-biter against Far Eastern University (FEU) Men’s football team 
        in the UAAP-ICSA pre-season tournament, 1-0.
        <br>
        <br>
        During the dying minutes of the game, MSU’s Randy Reyes manages to score a goal from outside the box, surprising the defenders and goalkeepers 
        with an unexpected finesse.
        <br>
        <br>
        Although the tournament had only begun, this victory against the football powerhouse led to the motivation for MSU to keep pushing further.
        <br>
        <br>
        After beating the Tamaraws, MSU would have no rest as they will be up against another powerhouse again, the Ateneo Blue Eagles.
    </div>
    <div class="article-navigation">
        <div></div>
        <a href="sports2.php" class="next-article">&lt; Back</a>
    </div>
</div>
