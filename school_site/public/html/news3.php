...
<header class="site-header">
    ...
    <div class="article-header">
            ...
            <img src = "../img/49th.png"class="article-photo">

        <h1 class="article-title">
           MSU COMMENCES 49TH FOUNDING ANNIVERSARY
        </h1>

        <p class="article-author">
            <strong>Author:</strong> Papa, Migel Rodrene Vens
        </p>
    </div>

    <div class="article-content">
       A blissful year has enveloped Meridian Scholar’s University (MSU) today, championship wins, international recognition, and many more 
       achievements within the University. Now, all of it will be cemented in history as MSU marks their 49th year with a celebration.
        <br>
        <br>
        The event started from June 16, 2025, until June 20, 2025, consisting of various activities such as booths, food stalls, games, and 
        an intramural-like competition between different colleges. 
        <br>
        <br>
        On the 4th day of the event, June 19, 2025, the current campus president, Ada Weng gave a speech for all the students in the school, 
        commending all the achievements they made throughout the years.
        <br>
        <br>
        “You have all done very well, especially for this year. This University wouldn’t be as great as it was now if it wasn’t for all the students
        that settle in them. This year, it’s all for you. For your achievements, and for all your greatness. To this, I say, Happy 49th Founding 
        Anniversary!”, Weng stated.
        <br>
        <br>
        49 years of history, achievements, and greatness has filled this school, and more is yet to come to the now prestigious Meridian State University.
    </div>
    <div class="article-navigation">
        <div></div>
        <a href="news2.php" class="next-article">&lt; Back</a>
    </div>
</div>
