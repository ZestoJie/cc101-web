...
<header class="site-header">
    ...
    <div class="back">
        <a href="sports.php" class="back-link">
            &lt; Return to MSU Sports
        </a>
    </div>

    <div class="article-header">

            <img src = "../img/uaap.png"class="article-photo">

        <h1 class="article-title">
           Rising Maroons topples Blue Hawks
        </h1>
    ...
    <div class="article-content">
        The MSU (Meridian Scholars University) Rising Maroons open with an explosive start to the Inter-college Sports Association (ICSA),
        placing them at the top of the league after demolishing the reigning champions, ISCP (International State College of the Philippines)
        Blue Hawks, 119-97, last Friday at the Mall of Asia Arena.
        <br>
        <br>
        Thought to be a slam dunk for the Blue Hawks, the Rising Maroons surprised the country after coming back after a 22-point deficit during 
        the first half, winning the game.
        <br>
        <br>
        This unexpected win puts MSU at the top of the league standings on the very first day, showing that they post a threat to the other teams 
        in the league.
        <br>
        <br>
        The Rising Maroons will next face the EIS (Elysium International School) Green Vipers for the second matchday, during the 24th of November 2025.
    </div>

    <div class="article-navigation">
        <div></div>
        <a href="sports2.php" class="next-article">Next Article &gt;</a>
    </div>
