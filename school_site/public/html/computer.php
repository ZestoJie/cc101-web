     ...
     <div id="main-content">
           ...
           <img src="../img/image.png" class="main-content-image">
            <div class="banner-overlay">
                ...
                <div class="breadcrumbs">
                        <a href="../home.php">HOME</a> • <a href="academics.php">ACADEMIC PROGRAMS</a> • COMPUTER STUDIES
                </div>
            </div>
        </div>
    </div>
        <div class="container">
            ...
            <div class="section-heading">
                <h1>College of Computer Studies Programs</h1>
                <p>Lead the digital revolution. Our programs combine theoretical knowledge with practical skills in software, data, and network infrastructure.</p>
            </div>
            ...
            <div class="program-grid">
                <div class="program-card">
                    ...
                    <div class="card-content">
                        <p>Focuses on planning, developing, installing, and maintaining computer systems and managing networks and databases. Prepares students for careers in IT support, network administration, and systems analysis.</p>
                ...
                <div class="program-card">
                    ...
                    <div class="card-content">
                        <p>Deep dive into the theory, design, implementation, and application of information and computation. Concentrates on algorithm design, software engineering, and artificial intelligence.</p>
                        <a href="#" class="btn-details">View Curriculum</a>
                    </div>
                </div>
                ...
                <div class="program-card">
                    ...
                    <div class="card-content">
                        <p>Bridging the gap between business needs and technology. Focuses on system analysis, process design, and the use of IT to solve organizational problems and achieve business goals.</p>
                        <a href="#" class="btn-details">View Curriculum</a>
                    </div>
                </div>
            </div>
