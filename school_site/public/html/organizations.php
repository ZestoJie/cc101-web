           ...
           <img src="../img/image.png" class="main-content-image">
            <div class="banner-overlay">
                    ...
                    <div class="breadcrumbs">
                        <a href="../home.php">HOME</a> • <a href="campuslife.php">CAMPUS LIFE</a> • ORGANIZATIONS
                    </div>
                </div>
            </div>
                </div>
...
<div class="choice">
    <a href="org1.php" class="news-card">
        <h3>Junior<br>Finance<br>Executives</h3>
    </a>

    <a href="org2.php" class="news-card">
        <h3>Meridian<br>Programmers'<br>League</h3>
    </a>

    <a href="org3.php" class="news-card">
        <h3>Meridian Society <br> of Young <br> Engineers</h3>
    </a>
    <a href="org4.php" class="news-card">
        <h3>Varsity<br>Athletes<br>Organization</h3>
    </a>
     <a href="org5.php" class="news-card">
        <h3>Rotary club<br>of<br>MSU</h3>
    </a>
     <a href="org6.php" class="news-card">
        <h3>Meridian<br>Student<br>Parliament</h3>
    </a>
</div>
