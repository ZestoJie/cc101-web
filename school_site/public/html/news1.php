...
<header class="site-header">
    ...
    <div class="article-header">
            ...
            <img src = "../img/news1.jpg"class="article-photo">

        <h1 class="article-title">
            MSU Becomes 3rd Top Performing University in the Country
        </h1>
    ...
    <div class="article-content">
        <p>
            Meridian State University (MSU) places third in uniRank’s 2025 top public universities 
            in the Philippines, following the University of the Philippines (UP) Diliman and the 
            Polytechnic University of the Philippines (PUP).
        </p>

        <p>
            This marks the University’s highest ranking in nearly five decades since its establishment, 
            surpassing other leading campuses such as UP Los Baños and UP Manila.
        </p>

        <p>
            Under the administration of the new campus president, Ada Weng, the University has shown 
            enormous improvements in academics, facilities, and the overall quality of students they 
            cultivate.
        </p>

        <p>
            With the new system in place, MSU is expected to continue rising, steadily moving toward 
            its vision of becoming a globally recognized top-performing institution.
        </p>
    </div>

    <div class="article-navigation">
        <div></div>
        <a href="news2.php" class="next-article">Next Article &gt;</a>
    </div>
