...
<header class="site-header">
    ...
    <div class="article-header">
        ...
        <h1 class="article-title">
            MSU Varsity Athletes Organization
        </h1>

    </div>

    <div class="article-content">
        The MSU Varsity Athletes Organization (MSU-VAO) is a dedicated student body that represents and supports the university’s varsity athletes 
        across various sports disciplines. It serves as a unifying community for student-athletes who strive to balance academic excellence with 
        athletic commitment. The organization promotes discipline, sportsmanship, and teamwork—values that define the identity of every athlete 
        representing MSU. Through its programs and initiatives, MSU-VAO aims to create an environment where athletes can grow not only in their chosen 
        sport but also as responsible and motivated individuals.
        <br>
        <br>
        MSU-VAO regularly organizes training programs, team-building activities, and wellness sessions designed to strengthen the physical and mental 
        resilience of its members. These efforts help athletes maintain peak performance while managing the challenges of academic life. The organization 
        also collaborates with coaches and sports coordinators to ensure that athletes receive the guidance and support they need both on and off the 
        field. Additionally, MSU-VAO plays a key role in hosting and participating in intercollegiate competitions, proudly showcasing the skills, 
        determination, and spirit of MSU athletes.
        <br>
        <br>
        Beyond athletic development, the organization emphasizes character building and leadership. Members are encouraged to take on responsibilities 
        that allow them to grow as leaders, mentors, and role models within the university community. MSU-VAO also advocates for athlete welfare, 
        promoting programs that support health, nutrition, time management, and academic assistance. Through these initiatives, the organization fosters 
        a nurturing environment where student-athletes feel valued and motivated to achieve their goals.
    </div>

    <div class="article-navigation">
        <div></div>
        <a href="org3.php" class="next-article">&lt; Back</a>
    </div>
    <div class="article-navigation">
        <div></div>
        <a href="org5.php" class="next-article">Next Article &gt;</a>
    </div>
